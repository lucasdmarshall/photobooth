...
const QuantityPage = () => {
  ...
  // Helper function to determine slot class for specific positioning
  const getSlotClass = (slot, index) => {
    if (!slot.gridColumn && !slot.gridRow) return '';
    
    if (slot.gridColumn && slot.gridColumn.includes('span')) {
      if (slot.gridColumn === '1 / span 4') return 'slot-1-span4';
      if (slot.gridColumn === '1 / span 2' && slot.gridRow === '1') return 'slot-1-span2';
      if (slot.gridColumn === '1 / span 2' && slot.gridRow === '2') return 'slot-1-span2-2';
      if (slot.gridColumn === '2 / span 2' && slot.gridRow === '1') return 'slot-2-span2';
      if (slot.gridColumn === '2 / span 3') return 'slot-2-span3';
      if (slot.gridColumn === '3 / span 2') return 'slot-3-span2';
      if (slot.gridColumn === '2 / span 2' && slot.gridRow === '2') return 'slot-2-span2-2';
    }
    
    if (slot.gridRow && slot.gridRow.includes('span')) {
      if (slot.gridColumn === '1') return 'slot-1-span2-rows';
      if (slot.gridColumn === '2 / span 2') return 'slot-2-span2-rows';
    }
    
    if (slot.gridColumn === '1' && slot.gridRow === '1') return 'slot-1-1';
    if (slot.gridColumn === '1' && slot.gridRow === '2') return 'slot-1-2';
    if (slot.gridColumn === '1' && slot.gridRow === '3') return 'slot-1-3';
    if (slot.gridColumn === '1' && slot.gridRow === '4') return 'slot-1-4';
    if (slot.gridColumn === '2' && slot.gridRow === '1') return 'slot-2-1';
    if (slot.gridColumn === '2' && slot.gridRow === '2') return 'slot-2-2';
    if (slot.gridColumn === '3' && slot.gridRow === '1') return 'slot-3-1';
    if (slot.gridColumn === '3' && slot.gridRow === '2') return 'slot-3-2';
    if (slot.gridColumn === '4' && slot.gridRow === '1') return 'slot-4-1';
    if (slot.gridColumn === '4' && slot.gridRow === '2') return 'slot-4-2';
      ...
      >
        {templates.map((template) => (
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
          >
            {/* Use the fallback component instead of styled-components */}
            <TemplateFallback 
              template={template}
            ...
            {/* Keep the original as a hidden backup */}
              ...
              >
                ...
                >
                  {template.slots.map((slot, index) => (
                    <PhotoSlot 
                      key={index}
                      className={`photo-slot ${getSlotClass(slot, index)}`}
